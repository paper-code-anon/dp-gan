...
epsilon_budgets = [[2, 5, 1],
                   [3, 4, 1],
                   [4, 3, 1],
                   [5, 2, 1]]

for i in range(10):
    dp_gan_folder = f'mlp_dp_loss_{i}'
    dp_gan_filename = 'gan_time_series_eps_2.csv'
    
    for epsilon_budget in epsilon_budgets:
    
        inverse_transformation_epsilon_budget, scores_gen_epsilon_budget, threshhold_gen_epsilon_budget = epsilon_budget
        ...
        path = f'{dp_gan_folder}_eps_2_{"_".join([str(eps) for eps in epsilon_budget])}'
        ...
        fake_df_with_scores = convert_la_to_scores(df_fakes=fake_df_with_inverse_transform,
                                                   batch_size=scores_gen_batch_size,
                                                   num_epochs=scores_gen_num_epochs,
        ...
        fake_df_with_threshhold = apply_threshhold_to_df(new_df=fake_df_with_inverse_transform,
        ...
        # Save utility image
        save_utility_image(path, final_name)